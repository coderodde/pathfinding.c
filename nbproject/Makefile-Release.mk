...
${OBJECTDIR}/bidir_dijkstra.o: bidir_dijkstra.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bidir_dijkstra.o bidir_dijkstra.c
...
${OBJECTDIR}/directed_graph_node.o: directed_graph_node.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/directed_graph_node.o directed_graph_node.c
...
${OBJECTDIR}/unordered_map.o: unordered_map.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unordered_map.o unordered_map.c

${OBJECTDIR}/unordered_set.o: unordered_set.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unordered_set.o unordered_set.c
...
${OBJECTDIR}/weight_function.o: weight_function.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/weight_function.o weight_function.c
